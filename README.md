...
\*\* If you want a custom path for Vice, edit file ~/Library/Application Support/Sublime Text 3/Packages/KickAss.sublime-build with the correct path to Vice (requires "download" install)

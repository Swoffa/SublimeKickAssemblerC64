...
custom_var_list = ["kickass_run_path", "kickass_debug_path", "kickass_args", "kickass_run_args", "kickass_debug_args"] 
...
class KickassBuildCommand(sublime_plugin.WindowCommand):
    ...
    def createCommand(self, sourceDict, buildMode):
        compileCommand = "java cml.kickass.KickAssembler \"${build_file_base_name}.${file_extension}\" -log \"bin/${build_file_base_name}_BuildLog.txt\" -o \"bin/${build_file_base_name}_Compiled.prg\" -vicesymbols -showmem -symbolfiledir bin ${kickass_args}"
